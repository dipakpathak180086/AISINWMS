...
namespace SchedulerExeAutoRestart
{
    static class Program
    {
        ...
        static void Main()
        {
            ...
            if (Process.GetProcessesByName("SchedulerExeAutoRestart").Length > 1)
            {                
                return;
            }
            ...
            var timer = new System.Threading.Timer((e) =>
            {
                ...
                writeToLogFile("Restart COMServer Scheduler Exe");
                Thread.Sleep(100000);
            ...
            while (_bl == true)
            {
                try
                {
                    ...
                    {
                        Process.Start(Application.StartupPath + "\\" + Exe);
                        writeToLogFile("File COMServer Sceduler Exe Start");                        
                    }
